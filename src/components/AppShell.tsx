      ...
      <aside className="hidden md:flex flex-col w-64 bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
        ...
        <div className="p-4 border-t border-sidebar-border">
          <div className="px-3 py-2 mb-2">
            <div className="text-xs text-sidebar-foreground/60 uppercase tracking-wider mb-1">{roleLabel}</div>
            <div className="text-sm font-medium truncate">{user?.email ?? user?.user_metadata?.display_name ?? "—"}</div>
          </div>
