...
import { LogOut, LayoutDashboard, Users, FileText, BookOpen, ShieldAlert, ShieldCheck, Library, Activity } from "lucide-react";
...
const navByRole: Record<AppRole, NavItem[]> = {
  ...
  teacher: [
    ...
    { to: "/teacher/live", icon: Activity, label: "Live monitoring" },
