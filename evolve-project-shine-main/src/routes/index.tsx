...
import WhyEduNexSection from "@/components/landing/WhyEduNexSection";
import StatsSection from "@/components/landing/StatsSection";
import HowItWorksSection from "@/components/landing/HowItWorks";
import FinalCTAPremium from "@/components/landing/FinalCTAPremium";
import TestimonialsSection from "@/components/landing/TestimonialsSection";
import PricingSection from "@/components/landing/PricingSection";
import FeaturesSection from "@/components/landing/FeaturesSection";
import AISectionPremium from "@/components/landing/AISectionPremium";
import SecuritySectionPremium from "@/components/landing/SecuritySectionPremium";
import FAQSectionPremium from "@/components/landing/FAQSectionPremium";
  ...
  head: () => ({
    meta: [
      { title: "EduNex — Globalna platforma edukacyjna nowej generacji z AI" },
      {
        name: "description",
        content:
          "EduNex — globalna platforma edukacyjna nowej generacji. Egzaminy online, AI Tutor, kursy, certyfikacja i zarządzanie szkołami. Dla uczniów, nauczycieli, szkół i firm na całym świecie.",
      },
    ],
  }),
});
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(180deg, oklch(0.5 0.15 270 / 0.12) 0%, oklch(0.6 0.18 200 / 0.08) 30%, oklch(0.5 0.15 240 / 0.05) 60%, transparent 100%)",
          filter: "blur(60px)",
        }}
        animate={{
          y: [0, -80, 0, 60, 0],
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(90deg, oklch(0.7 0.2 200 / 0.1) 0%, oklch(0.6 0.18 240 / 0.06) 50%, oklch(0.5 0.15 270 / 0.08) 100%)",
          filter: "blur(80px)",
        }}
        animate={{
          x: [0, 100, -50, 80, 0],
    ...
    () => [
      {
        ...
        dur: 8,
        delay: 0,
        color: "oklch(0.7 0.15 200 / 0.04)",
        radius: "42% 58% 55% 45% / 45% 52% 48% 55%",
      },
      {
        size: 120,
        top: "60%",
      ...
      },
      {
        ...
        dur: 12,
        delay: 4,
        color: "oklch(0.5 0.15 270 / 0.03)",
        radius: "48% 52% 40% 60% / 52% 44% 56% 48%",
      },
      {
        size: 100,
        top: "30%",
        ...
        dur: 7,
        delay: 1,
        color: "oklch(0.7 0.18 190 / 0.03)",
        radius: "50% 50% 45% 55% / 55% 45% 55% 45%",
      },
    ],
    [],
  );
    ...
    const draw = () => {
      ...
      for (const [i, j] of edges) {
        ...
        if (dist < 250) {
          ...
          ctx!.strokeStyle = `oklch(0.7 0.15 200 / ${0.06 * (1 - dist / 250)})`;
          ctx!.lineWidth = 0.5;
          ctx!.stroke();
          const pulse = Math.sin(Date.now() * 0.003 + i + j) * 0.5 + 0.5;
          ctx!.beginPath();
          ctx!.arc(nodes[i].x, nodes[i].y, nodes[i].r, 0, Math.PI * 2);
          ctx!.fillStyle = `oklch(0.7 0.15 200 / ${0.15 + pulse * 0.2})`;
          ctx!.fill();
          ctx!.beginPath();
...
function Landing() {
  ...
  useEffect(() => {
    ...
    btns.forEach((b) => {
      b.addEventListener("mousemove", f);
      b.addEventListener("mouseleave", reset);
    });
    return () => {
      btns.forEach((b) => {
        b.removeEventListener("mousemove", f);
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-canvas selection:bg-accent/30 selection:text-white overflow-x-hidden ${loaded ? "opacity-100" : "opacity-0"} transition-opacity duration-700`}
      >
...
function CookieBanner() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && localStorage.getItem("cookies-ok")) setV(false);
  }, []);
  if (!v) return null;
  return (
...
const QUIZ_DATA = [
  {
    q: "Ile wynosi pole kwadratu o boku 5 cm?",
    opts: [
      ["25 cm²", true],
      ["20 cm²", false],
      ["10 cm²", false],
    ...
    explain: "Pole = 5 × 5 = 25 cm²",
  },
  {
    q: "Która liczba jest podzielna przez 3?",
    opts: [
      ["124", false],
      ["327", true],
      ["401", false],
    ...
    explain: "3+2+7=12, a 12 dzieli się przez 3",
  },
  {
    q: "Jaki jest pierwiastek kwadratowy z 144?",
    opts: [
      ["10", false],
      ["14", false],
      ["12", true],
    ...
    <section className="relative py-28 sm:py-36 overflow-hidden section-premium">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="reveal text-center mb-14">
          <span className="section-label inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.06] text-white/50 backdrop-blur-sm">
            Demo na żywo
          </span>
          <h2 className="mt-6 text-4xl sm:text-5xl font-bold tracking-tight">
            <TextReveal text="Rozwiąż mini egzamin" />
          </h2>
          <p className="mt-3 text-white/40 text-sm">
            Zobacz jak działa platforma — 3 pytania z matematyki pod presją czasu.
          </p>
        </div>
        <div className="reveal-scale max-w-xl mx-auto">
            ...
            {step === "start" && (
              <div className="text-center" style={{ animation: "quizFade 0.4s ease-out" }}>
                <div className="w-20 h-20 mx-auto rounded-[24px] bg-gradient-to-br from-accent to-violet-500 grid place-items-center mb-6 shadow-lg">
                  <Notebook className="w-8 h-8 text-black" />
                </div>
                ...
                <div className="mt-3 flex justify-center gap-4 text-xs text-white/40">
                  ...
                  <span className="flex items-center gap-1">
                    <Target className="w-3.5 h-3.5" />3 pytania
                  </span>
                </div>
                <button
                  onClick={() => {
                  ...
                  className="mt-8 btn-shine inline-flex items-center gap-2 px-8 py-3.5 rounded-full font-medium text-sm bg-white text-black hover:bg-white/90 transition-all shadow-sm magnetic-btn"
                >
                  Rozpocznij quiz <Play className="w-4 h-4" />
                </button>
              </div>
            )}
              ...
              <div key={step} style={{ animation: "quizFade 0.35s ease-out" }}>
                <div className="flex items-center justify-between gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-1 text-xs text-white/30 font-mono">
                    ...
                    {totalTime > 0 ? `${Math.round(totalTime / 1000)}s` : "00s"}
                  </div>
                </div>
                <div className="flex gap-1 mb-6">
                  {[0, 1, 2].map((i) => (
                    ...
                    >
                      <div
                        className={`h-full rounded-full transition-all duration-700 ${i < qi ? "bg-accent" : i === qi && correct === true ? "bg-emerald-400" : i === qi && correct === false ? "bg-rose-400" : i === qi ? "bg-white/20" : ""}`}
                    ...
                    return (
                      ...
                      >
                        <span className="flex items-center gap-3">
                          ...
                          {selected && !isThis && !isC && (
                            <X className="w-4 h-4 text-rose-400/50 shrink-0" />
                          )}
                          {t as string}
                        </span>
                      </button>
                ...
                {showExplain && (
                  <div className="mt-4 text-xs text-accent/60 animate-pulse">{qData.explain}</div>
                )}
              </div>
            )}
            {step === "done" && (
              <div className="text-center" style={{ animation: "quizFade 0.5s ease-out" }}>
                <div
                  className="w-24 h-24 mx-auto rounded-[28px] grid place-items-center mb-6 shadow-lg bg-gradient-to-br from-accent to-blue-500"
                ...
                <h3 className="text-2xl font-bold">
                  {score === 3 ? "Perfect!" : score >= 2 ? "Dobra robota!" : "Spróbuj jeszcze raz"}
                </h3>
                <div className="mt-3 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.06] text-sm">
                  ...
                  <span
                    className={`font-bold font-mono ${score === 3 ? "text-emerald-300" : score >= 2 ? "text-accent" : "text-amber-300"}`}
                  >
                    {score}/3
                  </span>
                </div>
                ...
                <div className="mt-6 flex items-center justify-center gap-3">
                  <button
                    onClick={restart}
                    className="px-6 py-2.5 rounded-full text-sm font-medium border border-white/[0.08] text-white/50 hover:text-white hover:bg-white/[0.04] transition-all"
                  >
                    Rozwiąż ponownie
                  </button>
                  <Link
                    to="/auth/teacher"
                    className="btn-shine inline-flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-medium bg-white text-black hover:bg-white/90 transition-all shadow-sm"
                  >
          ...
          <div className="mt-4 text-center text-xs text-white/30">
            W rzeczywistym egzaminie AI sprawdza odpowiedzi otwarte i wykrywa ściąganie.
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-6 items-center">
              <div>
                <h3 className="text-lg font-bold flex items-center gap-2">
                  <Radio className="w-5 h-5 text-accent" /> Monitoring na żywo
                </h3>
                <p className="mt-2 text-sm text-white/40">
                  Widzisz postęp każdego ucznia w czasie rzeczywistym. AI wykrywa nieprawidłowości.
                </p>
                <ul className="mt-4 space-y-2 text-sm text-white/50">
                  {[
                    ["Postęp na żywo", "Widzisz kto skończył, a kto utknął"],
                    ["Wykrywanie ściągania", "AI analizuje ruchy myszy i ostrzega"],
                    ["Kontrola zdalna", "Możesz zatrzymać lub przedłużyć egzamin"],
                  ].map(([t, d]) => (
                    <li key={t} className="flex gap-2">
                      <span className="grad-dot" />
                      <div>
                        <span className="text-white/80">{t}</span> — {d}
                      </div>
                    </li>
                  ))}
                </ul>
                    ...
                    <div className="flex items-center justify-between pb-2 border-b border-white/[0.06]">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-white/50">
                          Na żywo: <span className="text-white font-medium">24 uczniów</span>
                        </span>
                      </div>
                      <span className="text-xs text-white/40">
                        Średnia: <span className="text-accent font-mono">73%</span>
                      </span>
                    </div>
                    {[
                      { n: "Kowalski J.", p: 88, c: "#34d399" },
                      { n: "Nowak A.", p: 72, c: "#22d3ee" },
                      { n: "Wiśniewska Z.", p: 95, c: "#34d399" },
                      { n: "Kamiński P.", p: 45, c: "#fb7185" },
                      ...
                      <div key={s.n} className="flex items-center gap-3">
                        ...
                        <div className="flex-1 h-2 rounded-full bg-white/[0.06] overflow-hidden">
                          <div
                            ...
                            style={{ width: `${s.p}%`, background: s.c, opacity: 0.7 }}
                          />
                        </div>
                        <span className="text-xs font-mono w-8 text-right text-white/50">
                          {s.p}%
                        </span>
                      </div>
                    ))}
  ...
  const cards = [
    {
      ...
      title: "Uczeń",
      lines: [
        "Wejście PIN-em bez konta",
        "Czysty interfejs egzaminu",
        "Wynik widoczny od razu",
        "Certyfikat PDF + QR",
        "AI rekomendacje materiałów",
      ],
    },
    {
      icon: Users,
      ...
      title: "Nauczyciel",
      lines: [
        "Pytania z AI w 3 sekundy",
        "Klasy, oceny, dziennik",
        "Monitoring na żywo",
        "Eksport PDF/Excel",
        "AI asystent głosowy",
      ],
    },
    {
      ...
      title: "Dyrekcja",
      lines: [
        "Zatwierdzanie nauczycieli",
        "Raporty zbiorcze",
        "Audyt i statystyki",
        "Wgląd w wyniki szkoły",
        "Panel nadzoru AI",
      ],
    },
    {
    ...
    <section className="relative py-28 sm:py-36 overflow-hidden section-premium">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="reveal text-center mb-14">
          ...
          <h2 className="mt-6 text-4xl sm:text-5xl font-bold tracking-tight">
            <TextReveal text="Cztery perspektywy, jedna platforma" />
          </h2>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-fr">
          {cards.map((c, i) => (
            ...
            >
              <Link
                to={c.to}
                className="group card-premium rounded-2xl p-6 hover:-translate-y-1 stagger-item flex flex-col w-full"
              >
                <div
                  className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${c.accent} grid place-items-center mb-4 shadow-sm transition-transform duration-300 group-hover:scale-110 shrink-0`}
                >
                ...
                <ul className="mt-3 space-y-2 text-sm text-white/50 flex-1">
                  {c.lines.map((l) => (
                    <li key={l} className="flex gap-2">
                      <CheckCircle2 className="w-4 h-4 text-accent/40 shrink-0 mt-0.5" />
                      <span>{l}</span>
                    </li>
                  ))}
                </ul>
    ...
    <section className="relative py-28 sm:py-36 overflow-hidden section-premium">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="reveal text-center mb-14">
          ...
          <h2 className="mt-6 text-4xl sm:text-5xl font-bold tracking-tight">
            <TextReveal text="Tradycyjnie vs EduNex" />
          </h2>
        </div>
        <div className="reveal space-y-3 relative">
          ...
          {rows.map((r, i) => (
            <div
              key={r.l}
              className="card-premium rounded-2xl px-4 sm:px-6 py-3 hover:-translate-y-[1px] transition-all cursor-default hover-glow stagger-item"
          ...
          <div className="text-center pt-2">
            <Link
              to="/auth/teacher"
              className="inline-flex items-center gap-2 px-5 py-2 rounded-full text-xs font-medium text-accent/70 hover:text-cyan-200 transition-colors"
            >
    ...
    <section className="relative py-28 sm:py-36 overflow-hidden section-premium">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="reveal text-center mb-14">
          ...
          <h2 className="mt-6 text-4xl sm:text-5xl font-bold tracking-tight">
            <TextReveal text="Platforma w liczbach" />
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {ACHIEVEMENTS.map((a, i) => (
            <div
              key={a.label}
              className={`reveal card-premium rounded-2xl p-6 text-center hover:-translate-y-1 hover-glow stagger-item ${i === 0 || i === 5 ? "sm:col-span-1" : ""}`}
              style={{ animationDelay: `${i * 0.06}s` }}
            >
              <div
                className={`w-14 h-14 mx-auto rounded-2xl bg-gradient-to-br ${a.color} grid place-items-center mb-4`}
              >
                <a.icon className="w-6 h-6 text-black" />
              </div>
              <div className="text-3xl sm:text-4xl font-bold">
                <span className={`bg-gradient-to-r ${a.color} bg-clip-text text-transparent`}>
                  {a.value}
                </span>
              </div>
  ...
  const capabilities = [
    {
      icon: BrainCircuit,
      title: "AI Tutor",
      desc: "24/7 asystent do nauki matematyki, języków, programowania",
      active: true,
    },
    {
      icon: FileText,
      title: "AI Generator",
      desc: "Generuj pytania egzaminacyjne z tematu, zdjęcia lub ilustracji",
      active: true,
    },
    {
      icon: Sparkles,
      title: "AI Ocenianie",
      desc: "Automatyczna ocena wypracowań i odpowiedzi otwartych",
      active: true,
    },
    {
      icon: Code2,
      title: "Code Mentor",
      desc: "Nauka programowania z interaktywnym asystentem kodu",
      active: true,
    },
    {
      icon: BarChart3,
      title: "Progress Analyzer",
      desc: "Analiza postępów z predykcją wyników AI",
      active: true,
    },
    {
      icon: ShieldCheck,
      title: "Plagiarism Detector",
      desc: "Wykrywanie plagiatów i AI-generated content",
      active: false,
    },
    {
      icon: BookOpen,
      title: "Course Generator",
      desc: "Automatyczne tworzenie kursów z dowolnego tematu",
      active: false,
    },
    {
      icon: Presentation,
      title: "Presentation Maker",
      desc: "Generowanie prezentacji z AI w kilka sekund",
      active: false,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="reveal text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-3 text-white/40 text-sm max-w-2xl mx-auto">
            EduNex wykorzystuje najnowsze modele AI do automatyzacji nauczania, oceniania i
              ...
              <motion.div
                animate={
                  c.active
                    ? {
                        boxShadow: [
                          "0 0 0px oklch(0.7 0.15 200 / 0)",
                          "0 0 20px oklch(0.7 0.15 200 / 0.15)",
                          "0 0 0px oklch(0.7 0.15 200 / 0)",
                        ],
                      }
                    : {}
            ...
            <div className="flex items-center gap-4">
              <div className="flex -space-x-2">
                {[Bot, BrainCircuit, Zap].map((Icon, i) => (
                  <div
                    key={i}
                    className={`w-9 h-9 rounded-full border-2 border-[oklch(0.06_0.03_270)] grid place-items-center ${i === 0 ? "bg-accent/20 text-accent" : i === 1 ? "bg-violet-500/20 text-violet-300" : "bg-amber-500/20 text-amber-300"}`}
                  >
              ...
              <div>
                <div className="text-sm font-medium text-white/80">
                  Modele AI: Gemini 3.5 Flash · GPT-4o · Claude 3.5
                </div>
                <div className="text-xs text-white/30 mt-0.5">
                  Własny gateway AI z automatycznym routingiem i fallbackiem
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2 text-xs text-white/40">
  ...
  const [messages, setMessages] = useState<{ role: string; content: string; code?: string }[]>([
    {
      role: "ai",
      content:
        "Cześć! Jestem AI Tutor EduNex. Mogę pomóc w nauce matematyki, języków, programowania i nie tylko. O co chcesz zapytać?",
    },
  ]);
    ...
    <section id="ai-demo" className="relative py-28 sm:py-36 overflow-hidden section-premium">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="reveal text-center mb-14">
          ...
          <h2 className="mt-6 text-4xl sm:text-5xl font-bold tracking-tight">
            <TextReveal text="Porozmawiaj z AI Tuturem" />
          </h2>
          <p className="mt-3 text-white/40 text-sm">
            Zadaj pytanie z dowolnego przedmiotu — AI rozumie kontekst i odpowiada z przykładami.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-6 reveal">
          {quickActions.map((a) => (
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = "oklch(0.7 0.15 200 / 0.3)";
                e.currentTarget.style.color = "oklch(0.7 0.15 200)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = "oklch(1 0 0 / 0.06)";
                e.currentTarget.style.color = "oklch(1 0 0 / 0.4)";
              }}
            >
        ...
        <div className="reveal-scale max-w-2xl mx-auto">
            ...
            <div ref={chatRef} className="h-80 overflow-y-auto p-5 space-y-4 scroll-smooth">
              {messages.map((m, i) => (
                <div
                  ...
                  style={{ animation: "chatFade 0.3s ease-out" }}
                >
                  {m.role === "ai" && (
                    ...
                    {(m as any).code && (
                      <div className="rounded-xl overflow-hidden border border-accent/10 bg-[oklch(0.03_0.02_270)]">
                        ...
                        >
                          ...
                          <button
                            onClick={() => {
                              navigator.clipboard.writeText((m as any).code);
                        ...
                        <pre
                          ...
                          style={{ color: "oklch(0.7 0.15 200 / 0.9)" }}
                        >
                          {(m as any).code}
                        </pre>
                      </div>
            ...
            <div className="flex items-center gap-2 p-3 border-t border-white/[0.06] bg-white/[0.01]">
              <button
                onClick={() => {
                  ...
                  toast.success(voiceMode ? "Tryb tekstowy" : "Tryb głosowy — powiedz pytanie");
                }}
                className="p-2 rounded-xl transition-all shrink-0"
                style={{
                  background: voiceMode ? "oklch(0.7 0.15 200 / 0.2)" : "oklch(1 0 0 / 0.04)",
                  color: voiceMode ? "oklch(0.7 0.15 200)" : "oklch(1 0 0 / 0.3)",
                  border: "1px solid oklch(1 0 0 / 0.06)",
                }}
              >
              ...
              <input
                ...
                placeholder={
                  voiceMode
                    ? "Powiedz coś lub wpisz..."
                    : "Zapytaj AI o matematykę, angielski, programowanie..."
                }
              ...
              <button
                onClick={() => {
                  ...
                  fileInput.onchange = () => toast.success("Plik przesłany — AI analizuje...");
                  fileInput.click();
                }}
                className="p-2 rounded-xl transition-all shrink-0"
                style={{
          ...
          <div className="mt-4 flex justify-center gap-4 text-[10px] text-white/30">
            ...
            <span>
              <button
                onClick={() => setInput("programowanie")}
                className="text-accent/70 hover:text-accent underline underline-offset-2"
              >
                list comprehension
              </button>
          ...
          <div className="mt-2 text-center text-[9px] text-white/20">
            AI może się mylić. Weryfikuj odpowiedzi z nauczycielem.
          </div>
        </div>
      </div>
...
const SECURITY_ITEMS = [
  {
    icon: Lock,
    title: "Szyfrowanie TLS 1.3",
    desc: "Dane przesyłane z szyfrowaniem klasy bankowej. Certyfikat SSL automatycznie odnawiany.",
    color: "from-accent to-blue-500",
  },
  {
    icon: Shield,
    title: "Ochrona przed atakami",
    desc: "WAF, DDoS protection, rate limiting. Monitoring 24/7 przez zespół bezpieczeństwa.",
    color: "from-accent to-blue-500",
  },
  {
    icon: Fingerprint,
    title: "RODO — pełna zgodność",
    desc: "Umowa powierzenia danych, dziennik audytu, prawo do bycia zapomnianym.",
    color: "from-accent to-blue-500",
  },
  {
    icon: Database,
    title: "Backupy co 6h",
    desc: "Automatyczne kopie na 3 niezależnych serwerach w różnych lokalizacjach w UE.",
    color: "from-accent to-blue-500",
  },
  {
    icon: ScanFace,
    title: "Tryb egzaminacyjny",
    desc: "Blokada skrótów, pełny ekran, monitoring aktywności, losowanie pytań.",
    color: "from-accent to-blue-500",
  },
  {
    icon: Building2,
    title: "Serwery w Polsce",
    desc: "Dane przechowywane w Warszawie i Krakowie. Poza jurysdykcją CLOUD Act.",
    color: "from-accent to-blue-500",
  },
  {
    icon: Users,
    title: "Kontrola dostępu RBAC",
    desc: "Role: admin, dyrektor, nauczyciel. 2FA dla administratora, dostęp tylko do własnych zasobów.",
    color: "from-accent to-blue-500",
  },
  {
    icon: Radio,
    title: "Monitoring 24/7",
    desc: "Automatyczne skanowanie podatności, testy penetracyjne co kwartał, SOC.",
    color: "from-accent to-blue-500",
  },
];
    ...
    <section className="relative py-28 sm:py-36 overflow-hidden section-premium">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="reveal text-center mb-14">
          ...
          <h2 className="mt-6 text-4xl sm:text-5xl font-bold tracking-tight">
            <TextReveal text="Dane bezpieczne jak w banku" />
          </h2>
          <p className="mt-3 text-white/40 text-sm">
            Certyfikaty, szyfrowanie i procedury — wszystko, czego wymaga nowoczesna szkoła.
          </p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {SECURITY_ITEMS.map((it, i) => (
            ...
            >
              <div
                className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${it.color} grid place-items-center mb-4`}
              >
        ...
        <div className="reveal mt-8 grid grid-cols-3 sm:grid-cols-6 gap-3 max-w-2xl mx-auto">
          {[
            ...
            <div
              key={n as string}
              className="flex flex-col items-center gap-2 p-4 rounded-2xl bg-white/[0.02] border border-white/[0.06] hover:bg-white/[0.04] transition-all"
            >
              <I className="w-5 h-5 text-accent/60" />
              <span className="text-[10px] text-white/50 text-center font-medium">
                {n as string}
              </span>
            </div>
          ))}
...
const FAQ = [
  {
    q: "Czy uczniowie muszą zakładać konto?",
    a: "Nie. Uczeń wchodzi przeglądarką, wpisuje PIN i imię. Konto nie jest wymagane — zero rejestracji.",
  },
  {
    q: "Czy mogę wgrać pytania z dokumentu?",
    a: "Tak. Wspieramy import z Worda, PDF oraz Excel. Możesz też wczytać zdjęcie — AI odczyta pytania automatycznie.",
  },
  {
    q: "Jak szybko mogę zacząć?",
    a: "Rejestracja trwa 2 minuty. Dla planu Klasa — dostęp od razu, bez karty płatniczej.",
  },
  {
    q: "Jak AI wykrywa ściąganie?",
    a: "AI analizuje ruchy myszy, wykrywa opuszczanie okna, porównuje odpowiedzi uczniów i wysyła alerty na żywo.",
  },
  {
    q: "Czy platforma działa na telefonie?",
    a: "Tak. EduNex działa w każdej przeglądarce — komputer, tablet, telefon. Bez instalacji.",
  },
  {
    q: "Czy mogę przetestować przed zakupem?",
    a: "Tak. Plan Klasa jest całkowicie darmowy — bez limitu czasu, bez karty, bez zobowiązań.",
  },
];
function FAQFlow() {
    ...
    <section id="faq" className="relative py-28 sm:py-36 overflow-hidden section-premium">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="reveal text-center mb-14">
          ...
          <h2 className="mt-6 text-4xl sm:text-5xl font-bold tracking-tight">
            <TextReveal text="Wątpliwości? Wyjaśniamy" />
          </h2>
        </div>
          ...
          {FAQ.map((it, i) => (
            <div key={it.q} className="card-premium rounded-2xl overflow-hidden">
              <button
                ...
                className="w-full flex items-center justify-between gap-4 px-6 py-4 text-left transition-colors hover:bg-white/[0.02]"
              >
                <span className="text-sm font-medium text-white/80 pr-4">{it.q}</span>
                <span
                  className={`shrink-0 w-7 h-7 rounded-full bg-white/[0.04] border border-white/[0.06] grid place-items-center transition-all duration-300 ${open === i ? "border-accent/30 text-accent rotate-45" : "text-white/30"}`}
                >
                  <Plus className="w-3.5 h-3.5" />
                </span>
              </button>
              <div
                className={`overflow-hidden transition-all duration-300 ease-out ${open === i ? "max-h-48" : "max-h-0"}`}
              >
        ...
        <div className="reveal">
          {sent ? (
            <div className="card-premium rounded-2xl p-8">
              ...
              <h2 className="text-2xl font-bold text-emerald-300">Jesteś zapisany!</h2>
              <p className="mt-2 text-sm text-white/50">Nowości i porady — raz na dwa tygodnie.</p>
            </div>
          ) : (
            <>
              ...
              <p className="mt-3 text-white/40 text-sm">
                Nowe funkcje, porady i aktualności — raz na dwa tygodnie, zero spamu.
              </p>
              <form onSubmit={onSubmit} className="mt-6 flex items-center gap-2 max-w-sm mx-auto">
                ...
                <button
                  type="submit"
                  className="btn-shine px-5 py-3 rounded-full text-sm font-medium bg-white text-black hover:bg-white/90 transition-all shrink-0 magnetic-btn"
                >
                  <Send className="w-4 h-4" />
                </button>
              </form>
    ...
    try {
      await submit({
        data: {
          ...
          subject: String(fd.get("subject") ?? "Zapytanie"),
        ...
        <div className="reveal card-premium rounded-2xl p-6 sm:p-10">
          <div className="grid lg:grid-cols-5 gap-8">
            <div className="lg:col-span-2">
              <span className="section-label inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.06] text-white/50 backdrop-blur-sm mb-4">
                Kontakt
              </span>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li className="flex gap-3">
                  ...
                  <div>
                    <div className="text-white/80">kontakt@edunex.pl</div>
                    <div className="text-xs text-white/40">Sekretariat</div>
                  </div>
                </li>
                <li className="flex gap-3">
                  <Phone className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                  <div>
                    <div className="text-white/80">+48 22 100 12 34</div>
                    <div className="text-xs text-white/40">Pon–Pt, 8:00–16:00</div>
                  </div>
                </li>
              </ul>
            </div>
            <form onSubmit={onSubmit} className="lg:col-span-3 grid sm:grid-cols-2 gap-3">
              <input
                ...
                className="sm:col-span-2 px-5 py-3 rounded-xl bg-white/[0.04] border border-white/[0.06] text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-accent/30 transition-all"
              />
              <input
                name="email"
                type="email"
              ...
              <textarea
                ...
                className="sm:col-span-2 px-5 py-3 rounded-xl bg-white/[0.04] border border-white/[0.06] text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-accent/30 transition-all resize-none"
              />
              <div className="sm:col-span-2 flex items-center justify-between gap-3">
                ...
                <button
                  disabled={busy}
                  type="submit"
                  className="btn-shine inline-flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-medium bg-white text-black hover:bg-white/90 disabled:opacity-50 transition-all relative magnetic-btn"
                >
                  {busy ? (
      ...
      <div className="bg-black/70 backdrop-blur-2xl border-t border-white/[0.06] py-3 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-white/60 max-sm:hidden">
              <span className="text-white font-medium">Ponad 36 000</span> użytkowników już korzysta
            </span>
            <span className="text-sm text-white/60 sm:hidden">36 000+ użytkowników</span>
          </div>
          <Link
            to="/auth/teacher"
            className="btn-shine inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium bg-white text-black hover:bg-white/90 transition-all shadow-sm shrink-0 magnetic-btn"
          >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-[12px] bg-gradient-to-br from-accent to-fuchsia-500 p-[1.5px] shadow-lg">
                <div className="w-full h-full rounded-[10px] bg-[oklch(0.06_0.03_270)] grid place-items-center">
                  ...
                  >
                    <defs>
                      <linearGradient id="logoGradF" x1="0" y1="0" x2="24" y2="24">
            ...
            <p className="mt-3 text-xs text-white/40 leading-relaxed max-w-xs">
              Nowoczesna platforma egzaminacyjna dla polskich szkół. Zgodna z wytycznymi MEN i RODO.
            </p>
            <div className="mt-4 flex items-center gap-2">
              {[Github, MessageSquare].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-8 h-8 rounded-full bg-white/[0.04] border border-white/[0.06] grid place-items-center text-white/30 hover:text-white hover:bg-white/[0.08] transition-all"
                >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/40">
              <li>
                <Link to="/auth/student" className="hover:text-white transition-colors">
                  Uczeń
                </Link>
              </li>
              <li>
                <Link to="/auth/teacher" className="hover:text-white transition-colors">
                  Nauczyciel
                </Link>
              </li>
              <li>
                <a href="#funkcje" className="hover:text-white transition-colors">
                  Funkcje
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/40">
              <li>
                <Link to="/dokumenty" className="hover:text-white transition-colors">
                  Regulamin
                </Link>
              </li>
              <li>
