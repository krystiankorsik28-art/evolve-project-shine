...
function StudentDashboard() {
  ...
  if (checking) {
    return (
      <div className="min-h-screen bg-slate-50 text-slate-900 grid place-items-center">
  ...
  return (
    <div className="min-h-screen bg-[#f6f8fb] text-slate-950">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <section className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          >
            ...
            <button
              ...
              className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-slate-950 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-45"
            >
        ...
        <nav className="mt-6 overflow-x-auto rounded-lg border border-slate-200 bg-white p-1 shadow-sm">
