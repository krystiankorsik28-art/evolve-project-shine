...
export function GlassPanel({ variant = "card", className = "", children }: { variant?: GlassVariant; className?: string; children: ReactNode }) {
  return <div className={`rounded-xl ${variantStyles[variant]} ${className}`}>{children}</div>;
}
