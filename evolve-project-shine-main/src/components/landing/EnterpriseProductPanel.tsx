...
export function EnterpriseProductPanel() {
  return (
    <section className="rounded-[34px] border border-slate-200 bg-white p-5 shadow-[0_30px_100px_rgba(15,23,42,.10)]">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <Box value="128" label="uczniów" />
        <Box value="94" label="oddane" />
        <Box value="82%" label="średnia" />
      </div>
